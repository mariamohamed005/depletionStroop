...
function welcomeMessageRoutineBegin() {
  ...
  for (const thisComponent of welcomeMessageComponents)
...
function instrStroopRoutineBegin() {
  ...
  for (const thisComponent of instrStroopComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function stroopBreakRoutineBegin() {
  ...
  for (const thisComponent of stroopBreakComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function instrMathRoutineBegin() {
  ...
  for (const thisComponent of instrMathComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function instrReminderRoutineBegin() {
  ...
  for (const thisComponent of instrReminderComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
